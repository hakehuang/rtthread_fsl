...
platform = "twrk64f120m"
@entry_yml = "projects/nxp/#{platform}.yml"
...
translated_data[0].each_key do |proj|
  options = {
    "paths" => {
     "default_path" => Dir.pwd + "/../../pg",
    ...
    "all" => translated_data[0][proj]
  }

  translated_data[0][proj]['document'] = {
    "board" => "#{platform}",
    "project_name" => proj
  }
