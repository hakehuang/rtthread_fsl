...
Board settings
==============
The EDMA memory to memory demo is configured to use UART1 with PTC4 and PTC3 pins. To make OpenSDA serial
...
Prepare the Demo
================
1. Connect a mini USB cable between the PC host and the OpenSDA USB port (J2) on the board.
