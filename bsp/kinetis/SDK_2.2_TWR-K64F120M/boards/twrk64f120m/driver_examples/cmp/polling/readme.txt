...
Then change CMP analog input, and watch the change of LED.
    - CMP0_IN0 (Jump A71 on Elevator Tower) connected to VCC =3.3V (Jump B3 on Elevator Tower): LED GREEN on
    - CMP0_IN0 (Jump A71 on Elevator Tower) connected to GND (Jump B2 on Elevator Tower): LED GREEN off
