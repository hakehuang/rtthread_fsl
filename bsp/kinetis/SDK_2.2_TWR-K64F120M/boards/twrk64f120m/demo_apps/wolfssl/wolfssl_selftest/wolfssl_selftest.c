...
#include <wolfssl/wolfcrypt/error-crypt.h>
    ...
    #define selftest_printf dc_log_printf
#elif defined(FREESCALE_KSDK_BM)
    #include "fsl_debug_console.h"
    #define selftest_printf PRINTF
#else
    #define selftest_printf printf
#endif
...
{
    selftest_printf("in my Fips callback, ok = %d, err = %d\r\n", ok, err);
    selftest_printf("message = %s\r\n", wc_GetErrorString(err));
    selftest_printf("hash = %s\r\n", hash);

    if (err == IN_CORE_FIPS_E) {
        selftest_printf("In core integrity hash check failure, copy above hash\r\n");
        selftest_printf("into verifyCore[] in fips_test.c and rebuild\r\n");
    }
}

#endif /* HAVE_FIPS */

static void bench_print_features(void)
{
    char *text;
    selftest_printf("fsys=%lu\r\n", ((CORE_CLK_FREQ)));
    selftest_printf("Using following implementations:\r\n");
    ...
    text = "Software implementation";
#endif
    selftest_printf("  DES: %s\r\n", text);
#if defined(FREESCALE_LTC_TFM)
    text = "LTC HW accelerated";
#else
    text = "Software implementation";
#endif
    selftest_printf("  Asymmetric encryption: %s\r\n\n", text);
}
...
#include "fsl_ltc.h"
    ...
    if ( (ret = md5_test()) != 0)
        ...
        selftest_printf( "MD5      test passed!\r\n");
#endif
    ...
    if ( (ret = md2_test()) != 0)
        ...
        selftest_printf( "MD2      test passed!\r\n");
#endif
    ...
    if ( (ret = md4_test()) != 0)
        ...
        selftest_printf( "MD4      test passed!\r\n");
#endif
    ...
    if ( (ret = sha_test()) != 0)
        ...
        selftest_printf( "SHA      test passed!\r\n");
#endif
    ...
    if ( (ret = sha256_test()) != 0)
        ...
        selftest_printf( "SHA-256  test passed!\r\n");
#endif
    ...
    if ( (ret = sha384_test()) != 0)
        ...
        selftest_printf( "SHA-384  test passed!\r\n");
#endif
    ...
    if ( (ret = sha512_test()) != 0)
        ...
        selftest_printf( "SHA-512  test passed!\r\n");
#endif
    ...
    if ( (ret = ripemd_test()) != 0)
        ...
        selftest_printf( "RIPEMD   test passed!\r\n");
#endif
    ...
    if ( (ret = blake2b_test()) != 0)
        ...
        selftest_printf( "BLAKE2b  test passed!\r\n");
#endif
        ...
        if ( (ret = hmac_md5_test()) != 0)
            ...
            selftest_printf( "HMAC-MD5 test passed!\r\n");
    #endif
    ...
    if ( (ret = hmac_sha_test()) != 0)
        ...
        selftest_printf( "HMAC-SHA test passed!\r\n");
    #endif
        ...
        if ( (ret = hmac_sha256_test()) != 0)
            ...
            selftest_printf( "HMAC-SHA256 test passed!\r\n");
    #endif
        ...
        if ( (ret = hmac_sha384_test()) != 0)
            ...
            selftest_printf( "HMAC-SHA384 test passed!\r\n");
    #endif
        ...
        if ( (ret = hmac_sha512_test()) != 0)
            ...
            selftest_printf( "HMAC-SHA512 test passed!\r\n");
    #endif
        ...
        if ( (ret = hmac_blake2b_test()) != 0)
            ...
            selftest_printf( "HMAC-BLAKE2 test passed!\r\n");
    #endif
        ...
        if ( (ret = hkdf_test()) != 0)
            ...
            selftest_printf( "HMAC-KDF    test passed!\r\n");
    #endif
    ...
    if ( (ret = gmac_test()) != 0)
        ...
        selftest_printf( "GMAC     test passed!\r\n");
#endif
    ...
    if ( (ret = arc4_test()) != 0)
        ...
        selftest_printf( "ARC4     test passed!\r\n");
#endif
    ...
    if ( (ret = hc128_test()) != 0)
        ...
        selftest_printf( "HC-128   test passed!\r\n");
#endif
    ...
    if ( (ret = rabbit_test()) != 0)
        ...
        selftest_printf( "Rabbit   test passed!\r\n");
#endif
    ...
    if ( (ret = chacha_test()) != 0)
        ...
        selftest_printf( "Chacha   test passed!\r\n");
#endif
    ...
    if ( (ret = poly1305_test()) != 0)
        ...
        selftest_printf( "POLY1305 test passed!\r\n");
#endif
    ...
    if ( (ret = chacha20_poly1305_aead_test()) != 0)
        ...
        selftest_printf( "ChaCha20-Poly1305 AEAD test passed!\r\n");
#endif
    ...
    if ( (ret = des_test()) != 0)
        ...
        selftest_printf( "DES      test passed!\r\n");
#endif
    ...
    if ( (ret = des3_test()) != 0)
        ...
        selftest_printf( "DES3     test passed!\r\n");
#endif
    ...
    if ( (ret = aes_test()) != 0)
        ...
        selftest_printf( "AES      test passed!\r\n");

#ifdef HAVE_AESGCM
    if ( (ret = aesgcm_test()) != 0)
        return err_sys("AES-GCM  test failed!\r\n", ret);
    else
        selftest_printf( "AES-GCM  test passed!\r\n");
#endif
    ...
    if ( (ret = aesccm_test()) != 0)
        ...
        selftest_printf( "AES-CCM  test passed!\r\n");
#endif
#endif
    ...
    if ( (ret = camellia_test()) != 0)
        ...
        selftest_printf( "CAMELLIA test passed!\r\n");
#endif
    ...
    if ( (ret = idea_test()) != 0)
        ...
        selftest_printf( "IDEA     test passed!\r\n");
#endif

    if ( (ret = random_test()) != 0)
        return err_sys("RANDOM   test failed!\r\n", ret);
    else
        selftest_printf( "RANDOM   test passed!\r\n");

#ifdef WOLFSSL_STATIC_MEMORY
    if ( (ret = memory_test()) != 0)
        return err_sys("MEMORY   test failed!\r\n", ret);
    else
        selftest_printf( "MEMORY   test passed!\r\n");
#endif
    ...
    if ( (ret = rsa_test()) != 0)
        ...
        selftest_printf( "RSA      test passed!\r\n");
#endif
    ...
    if ( (ret = certext_test()) != 0)
        ...
        selftest_printf( "CERT EXT test passed!\r\n");
#endif
    ...
    if ( (ret = dh_test()) != 0)
        ...
        selftest_printf( "DH       test passed!\r\n");
#endif
    ...
    if ( (ret = dsa_test()) != 0)
        ...
        selftest_printf( "DSA      test passed!\r\n");
#endif
    ...
    if ( (ret = srp_test()) != 0)
        ...
        selftest_printf( "SRP      test passed!\r\n");
#endif
    ...
    if ( (ret = pwdbased_test()) != 0)
        ...
        selftest_printf( "PWDBASED test passed!\r\n");
#endif
    ...
    if ( (ret = openssl_test()) != 0)
        ...
        selftest_printf( "OPENSSL  test passed!\r\n");
#endif
    ...
    if ( (ret = ecc_test()) != 0)
        ...
        selftest_printf( "ECC      test passed!\r\n");
    #ifdef HAVE_ECC_ENCRYPT
        if ( (ret = ecc_encrypt_test()) != 0)
            return err_sys("ECC Enc  test failed!\r\n", ret);
        else
            selftest_printf( "ECC Enc  test passed!\r\n");
    #endif
#endif
    ...
    if ( (ret = curve25519_test()) != 0)
        ...
        selftest_printf( "CURVE25519 test passed!\r\n");
#endif
    ...
    if ( (ret = ed25519_test()) != 0)
        ...
        selftest_printf( "ED25519  test passed!\r\n");
#endif
    ...
    if ( (ret = cmac_test()) != 0)
        ...
        selftest_printf( "CMAC     test passed!\r\n");
#endif
    ...
    if ( (ret = compress_test()) != 0)
        ...
        selftest_printf( "COMPRESS test passed!\r\n");
#endif
    ...
    if ( (ret = pkcs7enveloped_test()) != 0)
        ...
        selftest_printf( "PKCS7enveloped test passed!\r\n");

    if ( (ret = pkcs7signed_test()) != 0)
        return err_sys("PKCS7signed    test failed!\r\n", ret);
    else
        selftest_printf( "PKCS7signed    test passed!\r\n");
#endif
...
#if defined(WOLFSSL_AES_DIRECT) && !(defined(FREESCALE_LTC) && defined(FREESCALE_AES_NO_256))
    {
        const byte niPlain[] =
        {
            0x6b,0xc1,0xbe,0xe2,0x2e,0x40,0x9f,0x96,
...
int aesgcm_test(void)
{
#if !(defined(FREESCALE_AES_NO_192) && defined(FREESCALE_AES_NO_256))
    Aes enc;
...
#if !(defined(FREESCALE_AES_NO_256))
{
...
#endif /* FREESCALE_AES_NO_256 */

#if !defined(HAVE_FIPS) && !(defined(FREESCALE_AES_NO_192))
{
    XMEMSET(resultT, 0, sizeof(resultT));
    XMEMSET(resultC, 0, sizeof(resultC));
    XMEMSET(resultP, 0, sizeof(resultP));
...
#endif /* HAVE_FIPS */
#endif /* !(defined(FREESCALE_AES_NO_192) && defined(FREESCALE_AES_NO_256)) */
    return 0;
}
...
#define IDEA_NB_TESTS_EXTRA 4
    ...
    for (i = 0; i < IDEA_NB_TESTS; i++) {
        ...
        if (ret != 0) {
            selftest_printf("wc_IdeaSetKey (enc) failed\r\n");
            return -1;
        }
        ...
        if (XMEMCMP(&v1_cipher[i], data, IDEA_BLOCK_SIZE)) {
            selftest_printf("Bad encryption\r\n");
            return -1;
        }
        ...
        if (ret != 0) {
            selftest_printf("wc_IdeaSetKey (dec) failed\r\n");
            return -1;
        }
        ...
        if (XMEMCMP(v1_plain[i], data, IDEA_BLOCK_SIZE)) {
            selftest_printf("Bad decryption\r\n");
            return -1;
        }
        ...
        if (ret != 0) {
            selftest_printf("wc_IdeaCbcEncrypt failed\r\n");
            return -1;
        }
        ...
        ret = wc_IdeaCbcDecrypt(&idea, msg_dec, msg_enc,
                                (word32)XSTRLEN(message)+1);
        if (ret != 0) {
            selftest_printf("wc_IdeaCbcDecrypt failed\r\n");
            return -1;
        }

        if (XMEMCMP(message, msg_dec, (word32)XSTRLEN(message))) {
            selftest_printf("Bad CBC decryption\r\n");
            return -1;
        }
    }
    ...
    for (i = 0; i < IDEA_NB_TESTS_EXTRA; i++) {
        ...
        if (XMEMCMP(v1_cipher_100[i], data, IDEA_BLOCK_SIZE)) {
            selftest_printf("Bad encryption (100 times)\r\n");
            return -1;
        }
...
int rsa_test(void)
{
    ...
    XMEMCPY(tmp, rsa_key_der_4096, sizeof_rsa_key_der_4096);
    ...
    int curve_id)
{
    ...
    if (ret != 0) {
        selftest_printf("wc_ecc_shared_secret %d\r\n", ret);
        ERROR_OUT(-1015, done);
    }
...
static int ecc_test_curve(WC_RNG* rng, int keySize)
{
    ...
    if (ret < 0) {
        selftest_printf("ecc_test_curve_size %d failed!: %d\r\n", keySize, ret);
        return ret;
    }
        ...
        if (ret < 0) {
            selftest_printf("ecc_test_vector %d failed!: %d\r\n", keySize, ret);
            return ret;
        }
    #endif
        ...
        if (ret < 0) {
            selftest_printf("ecc_test_key_gen %d failed!: %d\r\n", keySize, ret);
            return ret;
        }
    #endif
...
int ecc_test(void)
{
    ...
    #if defined(HAVE_ECC_BRAINPOOL) || defined(HAVE_ECC_KOBLITZ)
    {
        ...
        if (ret < 0) {
            selftest_printf("ecc_test_curve_size: type %d: failed!: %d\r\n", curve_id, ret);
            goto done;
        }
    }
    #endif
