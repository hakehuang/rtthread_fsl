...
The lwip_httpsrv_wolfssl demo application demonstrates an HTTPS Server set up on lwIP TCP/IP
 and the WolfSSL stack with bare metal. The user uses an Internet browser to send an https
 request for connection. The board acts as an HTTPS server and sends a Web page back to the PC.
...
Running the demo
================
1. When the demo runs successfully, the following message is displayed in the terminal:
		************************************************
